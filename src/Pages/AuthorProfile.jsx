...
//         if (snap.exists()) {
//           setUserInfo({ email: user.email, ...snap.data() });
//         }
//       }
//     });
...
//           <h1 className="text-3xl font-bold text-center text-gray-800 mb-6">Welcome, Author!</h1>
          
//           {userInfo ? (
//             <div className="flex flex-col items-center">
//               <div className="w-24 h-24 bg-blue-500 text-white flex items-center justify-center text-3xl rounded-full mb-4 shadow">
//                 {getInitials(userInfo.username)}
//               </div>
//               <div className="text-center space-y-2">
//                 <p><strong>Username:</strong> {userInfo.username || "Not set"}</p>
//                 <p><strong>Email:</strong> {userInfo.email}</p>
//                 <p><strong>Role:</strong> {userInfo.isAuthor ? 'Author' : 'User'}</p>
//               </div>
//             </div>
//           ) : (
